...
4.  **Agent Ecosystem:** You are part of a larger team of agents located in the `/agents` directory. Your interactions will be governed by the `TEAM_COMMUNICATION_PROTOCOL.md` found in `/INTELLIGENCE`.
