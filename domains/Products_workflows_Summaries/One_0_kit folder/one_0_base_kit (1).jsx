...
const One0 = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex flex-col items-center justify-center p-6">
      ...
      <input
        className="bg-neutral-800 border border-neutral-600 p-2 rounded mb-4 w-full max-w-md"
        placeholder="Type a test message for GPT"
        value={input}
        onChange={e => setInput(e.target.value)}
      />
      <div className="flex flex-wrap gap-4 mb-4 justify-center">
        <button onClick={handleGPT} disabled={loading} className="bg-white text-black font-semibold px-4 py-2 rounded">
          {loading ? 'Thinking...' : 'Call GPT-4o'}
        </button>
      </div>

      <button onClick={() => setShowAdmin(prev => !prev)} className="mb-6 px-4 py-2 border rounded text-sm">
